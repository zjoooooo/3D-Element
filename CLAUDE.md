...
v1.0 已发布(tag v1.0)。**M7-M12 均已完成**(各自计划文末有勘误)。**全任务复核已完成**:`docs/superpowers/reviews/2026-08-18-full-audit.md` —— 十二个里程碑账目零失踪(已收 9 / 复核修复 2 / 接受 10 / **待用户裁定 8** / 待立项 2),六项不变量横向扫描过,三套件+sim+报告全绿。复核顺手修了两处:BossSystem 每 tick 的 `here` 字面量分配、弑神一闪预瞄五个里程碑没跟上缩放射程(M6 T-later)。**下一步等用户:复核报告第五节的 8 条裁定,和第六节的 2 个立项候选。**
