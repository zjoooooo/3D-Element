...
v1.0 已发布(tag v1.0)。**M7 融合专属化已完成**(T1-T7)。**M8 第二波主动执行中**(计划 `docs/superpowers/plans/2026-08-17-m8-second-wave.md`;T1-T4 已合入,T5 修复轮待提交,余 T6 流火雨 / T7 收官)。用户指令的后续队列:**M9 → M10 → M11 → M12(需先写计划)→ 全任务复核**。
