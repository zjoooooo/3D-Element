...
Two or more equipped skills sharing a wuxing resonate (共鸣): 金 raises matchup advantage from 1.25× to 1.35×, 木 heals 1 hp per kill, 水 stretches slow duration ×1.5, 火 boosts burn-tick damage ×1.3 — 土's knockback bonus and 周天 (every wuxing represented at once, amplifying reaction damage a further ×1.5) both wait on an earth skill that doesn't exist yet (M6). Casting a skill within 4 s of the one that generates it (相生轮转) halves its cooldown and pops a toast. Once both parents reach level 4, a 相生 pair of seated skills can fuse into one gold seat and free the other — and since M7 each pair casts a **bespoke fusion spell**, one true skill in place of the old composite placeholder: 木+火 **业火燎原** drops a burning zone that forks a child zone at every corpse inside it (capped at five), 火+土 **地心火山** raises a cone that spits three scattered magma bombs, each stunning and leaving a lava pool, 土+金 **锋岩星阵** plants five gold prisms over a solid 3.5 m disc that grinds for three seconds and strips armour (a stacking 25 % vulnerability every source profits from), 金+水 **霜刃洪流** sweeps a blade tide out and back with the return hit critting anything slowed, and 水+木 **回春雷泽** pools a marsh that slows the horde, heals you while you stand in it, and answers with a chain-lightning bolt every 0.8 s. Every hit a fusion lands weighs **both** parents' wuxing and takes the better matchup, while marks and debuffs follow the generated half; mana charges once at the pricier parent, and the gold seat still levels 1→3 for +25 % damage a rank.
